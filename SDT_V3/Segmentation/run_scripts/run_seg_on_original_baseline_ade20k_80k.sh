...
CKPT="../Classification/Model_Large/02_baseline_pretrain_mae_2gpu_400ep/checkpoint-395.pth"
WORK_DIR="work_dirs/03_seg_on_original_baseline_ade20k_80k"

GPUS=2
PORT="${PORT:-29531}"
GPUS_TO_USE="${GPUS_TO_USE:-5,6}"

echo "=== ADE20K Segmentation: Baseline on ORIGINAL Spikformer ==="
